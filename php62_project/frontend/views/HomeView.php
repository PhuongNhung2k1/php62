<?php 
  // load file layputTrangChu.php vao day
...
<!-- new item -->
<div class="item">
<div class="article"> <a href="index.php?controller=news&action=detail&newsId=<?php echo $rows->id; ?>" class="image"> <img src="../assets/frontend/images/chicago.jpg" alt="<?php echo $rows->name; ?>" title="<?php echo $rows->name; ?>" class="img-responsive"> </a>
  <div class="info">
    <h3><a class="text3line" href="index.php?controller=news&action=detail&newsId=<?php echo $rows->id; ?>" style="font-weight: bold;"><?php $rows->photo; ?></a></h3>
