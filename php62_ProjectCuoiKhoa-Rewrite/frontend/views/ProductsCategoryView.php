 ...
 <main class="container category_prod products">
        ...
        <div class="cate_product">
            <div class="cate_Byresult-search">
                ...
                <ul>
                    <li><a href="index.php?controller=products&action=category&catId=1">Mới nhất</a></li>
                    <li><a href="index.php?controller">Liên quan</a></li>
                    <li><a href="index.php?controller=products&action=category&catId=2">Bán chạy nhất</a></li>
                    <li><a href="index.php?controller=products&action=category&catId=5">Sale</a></li>
                </ul>
            </div>
            <h2>
            <?php 
