<?php
	trait CartModel{		
		...
		public function cartCheckOut(){
			...
			$query = $conn->prepare("insert into orders set customer_id=:customer_id,current_address=:current_address,date=now(),price=:price");
			$query->execute(array("customer_id"=>$customer_id,"current_address"=>$current_address,"price"=>$price));
			//lay id vua moi insert
